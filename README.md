...
# Dependencies
There are no other dependencies required to use the control system except for the _Energia_, _Code Composer Studio_ and a version of _Python_ **3.6.9** or newer.
